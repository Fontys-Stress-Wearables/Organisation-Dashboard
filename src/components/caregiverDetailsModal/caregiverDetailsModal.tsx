  ...
  return (
      <>
        <Modal size="xl" show={show} onHide={closeModal} aria-labelledby="contained-modal-title-vcenter" centered>
          ...
          <Modal.Body>
            <p><b>Job title: </b>{caregiver && caregiver.jobTitle}</p>
            <p><b>E-mail address: </b>{caregiver && caregiver.mail ? caregiver.mail : "-"}</p>
            <p><b>Phone: </b>{caregiver && caregiver.mobilePhone ? caregiver.mobilePhone : "-"}</p>
          </Modal.Body>
          <Modal.Footer>
